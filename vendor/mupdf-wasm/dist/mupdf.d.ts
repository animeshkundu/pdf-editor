...
export declare class PDFFontDescriptor extends Userdata<"pdf_font_desc"> {
    static readonly _drop: (font: Pointer<"pdf_font_desc">) => void;
    constructor(pointer: Pointer<"pdf_font_desc">);
    getName(): string;
    isEmbedded(): boolean;
    getWritingMode(): number;
}
...
export declare class Document extends Userdata<"any_document"> {
    ...
    countPages(): number;
    isReflowable(): void;
    style(publisherCSS: boolean, userCSS: string): void;
...
export type PDFOperatorHandle = PDFFontDescriptor | PDFObject | Image | ColorSpace | Shade;
...
export declare class PDFProcessorTrace extends Userdata<"wasm_pdf_processor_trace"> {
    static readonly _drop: (trace: Pointer<"wasm_pdf_processor_trace">) => void;
    private readonly _doc;
    private readonly _ownedHandles;
    private _records;
...
export declare class PDFPage extends Page {
    ...
    getObject(): PDFObject;
    getTransform(): Matrix;
    processContents(): PDFProcessorTrace;
    filterContents(options?: PDFFilterPageOptions): void;
...
export declare class PDFObject extends Userdata<"pdf_obj"> {
    ...
    put(key: number | string | PDFObject, value: any): PDFObject;
    _putValue(key: number | string | PDFObject, value: any): void;
    push(value: any): PDFObject;

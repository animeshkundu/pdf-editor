...
interface Libmupdf {
	...
	_wasm_style_document(doc: Pointer<"any_document">, publisher_css: boolean, user_css: Pointer<"char">): void,
	...
	_wasm_pdf_set_js_execution_enabled(doc: Pointer<"any_document">, enabled: boolean): void,
	_wasm_pdf_js_execution_enabled(doc: Pointer<"any_document">): number,
	_wasm_pdf_js_budget_exhausted(doc: Pointer<"any_document">): number,
	_wasm_pdf_set_js_event_listener(doc: Pointer<"any_document">, enabled: boolean): void,
	_wasm_pdf_execute_js(doc: Pointer<"any_document">, name: Pointer<"char">, source: Pointer<"char">): Pointer<"fz_buffer">,
	...
	_wasm_pdf_load_stream_max(obj: Pointer<"pdf_obj">, max_bytes: number): Pointer<"fz_buffer">,
	...
	_wasm_pdf_process_page_contents(page: Pointer<"any_page">): Pointer<"wasm_pdf_processor_trace">,
	_wasm_pdf_processor_trace_get_data(trace: Pointer<"wasm_pdf_processor_trace">): Pointer<"char">,
	_wasm_pdf_processor_trace_get_length(trace: Pointer<"wasm_pdf_processor_trace">): number,
	_wasm_pdf_drop_processor_trace(trace: Pointer<"wasm_pdf_processor_trace">): void,
	_wasm_pdf_keep_font(font: Pointer<"pdf_font_desc">): Pointer<"pdf_font_desc">,
	_wasm_pdf_drop_font(font: Pointer<"pdf_font_desc">): void,
	_wasm_pdf_font_name(font: Pointer<"pdf_font_desc">): Pointer<"char">,
